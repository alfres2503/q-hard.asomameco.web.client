        ...
        >
            ...
            {/* <div className={`flex gap-5 items-center ${toggle ? "bg-none transition-all duration-300 delay-200" : "bg-white rounded-xl p-2"}`}>
                ...
                <div className={` ${toggle ? "opacity-0 delay-200" : ""}`}>
                    <h3 className="text-xl">Pala Lops</h3>
                    <span className="text-[0.75rem] opacity-60">correo@gmail.com</span>
                </div>
            </div> */}
            ...
            {currentMember ? (
                <div>
                    <div className={`flex gap-5 items-center ${toggle ? "bg-none transition-all duration-300 delay-200" : "bg-white rounded-xl p-2"}`}>
                        ...
                        <div className={` ${toggle ? "opacity-0 delay-200" : ""}`}>
                            <h3 className="text-xl">{currentMember.firstName} {currentMember.lastName}</h3>
