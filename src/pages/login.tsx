...
import AsomamecoLogo from "/public/Logo.svg";
    ...
    <>
      ...
      <section className="min-h-screen flex items-stretch text-white  bg-[#012245]  ">
        <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center  bg-[url(../../public/images/asking.jpg)]  ">
          ...
          <div className="bottom-0 absolute p-4 text-center right-0 left-0 flex justify-center">
            <a className="mb-5 hover:underline hover:text-gray-100 my-7" href="#">
              ¿Aún no tienes una cuenta? Regístrate aqui!
            </a>
          </div>
        </div>
        <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 background-color: black; ">
          ...
          <div className="w-full py-6 z-20">
            ...
            <p className="text-gray-200 my-2 mb-6">Por favor inicia sesión con tu cuenta.</p>
            <LoginForm />
          </div>
        </div>
      </section>
